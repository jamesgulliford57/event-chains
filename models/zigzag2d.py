...
class ZigZag2d(PDMP):
    def __init__(self, num_samples, final_time, event_time_func, x0=0.0, v0=1, dim=2, poisson_thinned=False, 
...
class GaussZigZag2d(ZigZag2d):
    ...
    def __init__(self, num_samples, final_time, x0=0.0, v0=1, dim=2, poisson_thinned=False, 
                 event_rate=None, event_rate_bound=None):
